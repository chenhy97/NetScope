...
#define QUANTILE_UPDATE(num) \
    ...
    if (meta.quantile_value_sketch##num == 0){\
        ...
        if (meta.latency < meta.quantile_value_sketch##num){ \ 
            meta.lambda_value##num = ((meta.max_gap_value_sketch##num >> 3) + (meta.min_gap_value_sketch##num >> 1) );\ 
            ...
            meta.lambda_value##num = ((meta.max_gap_value_sketch##num >> 4) + meta.min_gap_value_sketch##num );\ 
